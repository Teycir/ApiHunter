...
3. Add target-list input/import support and multi-target scan profiles.
4. Add auth-flow/session-file UI wiring and secure local credential storage ergonomics.
